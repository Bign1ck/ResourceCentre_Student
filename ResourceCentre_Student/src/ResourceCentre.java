...
public class ResourceCentre {
	...
	public static String retrieveAllCamcorder(ArrayList<Camcorder> camcorderList) {
		...
		for (Camcorder camcorder : camcorderList) {
			if (camcorder.getIsAvailable()) {
				output.append(String.format("%-10s %-30s %-10s %-10s %-20d\n",
						camcorder.getAssetTag(), camcorder.getDescription(),
	...
	public static String retrieveAllChromebook(ArrayList<Chromebook> chromebookList) {
		...
		for (Chromebook chromebook : chromebookList) {
			String availability = showAvailability(chromebook.getIsAvailable());
			output += String.format("%-10s %-30s %-10s\n",
					chromebook.getAssetTag(), chromebook.getDescription(), availability);
		}
	...
	public static void addChromebook(ArrayList<Chromebook> chromebookList, Chromebook cb) {
		...
		if ((cb.getAssetTag().isEmpty()) || (cb.getDescription().isEmpty()) || (cb.getOs().isEmpty())) {
			return;
		}
	...
	public static void returnChromebook(ArrayList<Chromebook> chromebookList) {
		viewAllChromebook(chromebookList); // Display the available chromebooks
		...
		if (isReturned) {
			...
			System.out.println("Invalid asset tag or chromebook is not on loan");
		}
	}
